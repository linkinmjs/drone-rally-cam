# Modified from GodotDrone (GPL-3.0, (c) Cykyrios), 2026: added idle_power().
...
## Throttle value that means "do nothing" in this mode. Arming requires the stick there:
## fully down for direct-throttle modes, centred for modes where the stick sets a climb rate.
